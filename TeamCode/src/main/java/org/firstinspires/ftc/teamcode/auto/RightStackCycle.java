...
public class RightStackCycle extends OpMode {
    ...
    public void init() {
        ...
        // initialize bot
        bot = new Volta(
                (FieldDimensions.cellCount - 2) * FieldDimensions.cellSize + FieldDimensions.cellMesh / 2 + Volta.wheelWidth + Volta.frameX / 2,
    ...
    public void loop() {
        ...
        if (bot.next(bot.nav)) {
            bot.nav.setTarget(0, 0, (FieldDimensions.cellCount - 1.5) * FieldDimensions.cellSize, 2 * FieldDimensions.cellSize, 0);
        ...
        if (bot.next(bot.nav, bot.slide)) {
            bot.nav.setTarget(0, 0, (FieldDimensions.cellCount - 1.5) * FieldDimensions.cellSize, 2.25 * FieldDimensions.cellSize, 0);
